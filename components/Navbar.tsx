...
function Navbar() {
  return (
    <nav className="flex items-center justify-between space-x-2 px-6 md:px-10 py-6 mx-2 my-4 bg-gradient-to-tr from-[#77BA99] to-[#45785f] rounded-xl">
      <div className="logo flex items-center justify-center space-x-2">
        ...
        <div className="flex flex-col -space-y-2">
          <h1 className="font-titilium_semibold text-xs md:text-lg">
            stacked-stories
          </h1>
          <h1 className="font-light text-[9px] md:text-sm relative top-1">
            technical blogs
          </h1>
        </div>
      </div>
